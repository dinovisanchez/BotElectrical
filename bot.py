...
PROMPT_SISTEMA_RETIE = (
    ...
    "Divide SIEMPRE tu respuesta en DOS partes separadas por una linea en blanco:\n"
    "\n"
    "PARTE 1 — RESPUESTA DIRECTA\n"
    "  2 a 4 oraciones. La respuesta concreta a lo que se pregunto, sin relleno.\n"
    "  Incluye el articulo o numeral normativo clave.\n"
    "\n"
    "PARTE 2 — DETALLE TECNICO COMPLETO\n"
    "  Todo lo relevante: requisitos, excepciones, valores numericos, referencias\n"
    "  de articulo/pagina, implicaciones practicas. Usa listas cuando aplique.\n"
    "\n"
